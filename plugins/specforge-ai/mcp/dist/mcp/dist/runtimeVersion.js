...
exports.readRuntimeVersionAsync = readRuntimeVersionAsync;
const fs = __importStar(require("node:fs"));
const path = __importStar(require("node:path"));
let cachedRuntimeVersion;
async function readRuntimeVersionAsync() {
    ...
    if (versionDefinitionRaw) {
        try {
            const versionDefinition = JSON.parse(versionDefinitionRaw);
...
async function tryReadTextFileAsync(filePath) {
    try {
...
//# sourceMappingURL=runtimeVersion.js.map