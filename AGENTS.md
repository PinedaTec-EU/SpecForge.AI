...
- For this repository, the version bump is not considered complete unless the new runtime version is visible in `version.nfo`, `version_definition.json`, and `plugins/specforge-ai/.codex-plugin/plugin.json`.
